---
title: Checking data automatically
---
...
![Screenshot of GitHub actions with a broken run](/tutorial/tutorial-checking-data-automatically-broken.png)

Click on the run, then check and expand the broken item to see the details of the problem.

![Screenshot of GitHub actions with details of a broken run](/tutorial/tutorial-checking-data-automatically-broken-details.png)
...
![Screenshot of GitHub actions with a fixed run](/tutorial/tutorial-checking-data-automatically-pass.png)
