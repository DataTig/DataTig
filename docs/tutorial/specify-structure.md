...
![Screenshot of a list of bike shops](/tutorial/tutorial-specify-structure-screenshot-list.png)

Click on the Digital Dan shop.

You should see more information on the fields and information on the error it found.

![Screenshot of details of a bike shop](/tutorial/tutorial-specify-structure-screenshot-detail.png)
...
![Screenshot of editing a bike shop](/tutorial/tutorial-specify-structure-screenshot-detail-edit.png)
